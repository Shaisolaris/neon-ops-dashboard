    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-orange-500 hover:bg-orange-600 text-white" onClick={() => toast("Agent deployment queued — ETA 3 minutes")}>Deploy Agent</Button>
          ...
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-2xl">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 pt-4">
                <Button className="bg-orange-500 hover:bg-orange-600 text-white" onClick={() => toast("Mission assigned to field team")}>Assign Mission</Button>
                <Button
                  variant="outline"
                  className="border-neutral-700 text-neutral-400 hover:bg-neutral-800 hover:text-neutral-300 bg-transparent"
                 onClick={() => toast("Loading archive...")}>
                  View History
                </Button>
                <Button
                  variant="outline"
