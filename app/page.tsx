      ...
      <div className={`flex-1 flex flex-col ${!sidebarCollapsed ? "md:ml-0" : ""}`}>
        ...
        <div className="h-16 bg-neutral-800 border-b border-neutral-700 flex items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button variant="ghost" size="icon" className="text-neutral-400 hover:text-orange-500" onClick={() => toast("3 new alerts", { description: "Agent 7 offline • Perimeter breach sector 4 • System update available" })}>
              <Bell className="w-4 h-4" />
            </Button>
            <Button variant="ghost" size="icon" className="text-neutral-400 hover:text-orange-500" onClick={() => toast.success("Data refreshed", { description: "All systems nominal" })}>
